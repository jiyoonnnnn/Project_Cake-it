...
//                RequestBody cakeColor = RequestBody.create(MediaType.parse("multipart/form-data"), intent.getStringExtra("cake_color"));
//                RequestBody cakeFlavor = RequestBody.create(MediaType.parse("multipart/form-data"), intent.getStringExtra("cake_flavor"));
//                RequestBody pickupDate = RequestBody.create(MediaType.parse("multipart/form-data"), String.format("%04d-%02d-%02d %02d:%02d", year, month, day, hour, min));
//                RequestBody lettering = RequestBody.create(MediaType.parse("multipart/form-data"), intent.getStringExtra("lettering"));
//                RequestBody shop_id = RequestBody.create(MediaType.parse("multipart/form-data"), String.valueOf(0));
//
